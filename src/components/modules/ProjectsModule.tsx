...
// import { Boxes, Cpu, Activity, ArrowUpRight } from 'lucide-react';
...
//   return (
//     <ModuleShell title="Projects" codename="HOLOGRAPHIC ARTIFACT TABLE" accent="cyan" onClose={onClose}>
//       {selected ? (
...
//                 <span className={`font-mono text-[10px] px-2 py-0.5 rounded border ${statusColor[selected.status]}`}>
//                   {selected.status}
//                 </span>
//                 <span className="font-mono text-[10px] text-cyan-400/50">{selected.codename}</span>
//               </div>
...
//               {/* holographic artifact visual */}
//               <div className="relative aspect-square rounded-xl glass overflow-hidden flex items-center justify-center">
...
//                   <div className="absolute inset-4 rounded-full border border-emerald-400/20 animate-spin-reverse" />
//                   <div className="absolute inset-0 flex items-center justify-center">
//                     <Boxes className="w-16 h-16 text-cyan-300/80 animate-float" />
//                   </div>
//                   <div className="absolute -inset-2 rounded-full bg-cyan-400/10 blur-2xl animate-pulse-glow" />
//                 </div>
//               </div>
//             </div>
//           </div>
...
//                 <div className="w-10 h-10 rounded-lg border border-cyan-400/30 bg-cyan-400/5 flex items-center justify-center group-hover:animate-float">
//                   <Boxes className="w-5 h-5 text-cyan-300" />
//                 </div>
//                 <span className={`font-mono text-[9px] px-2 py-0.5 rounded border ${statusColor[p.status]}`}>
//                   {p.status}
//                 </span>
//               </div>
